<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cadastrar.aspx.cs" Inherits="Fahbula_ASP.cadastrar" %>
...
<body style="height: 100%;">
    <div class="login-clean" style="height: 100%;background-color: rgb(40,40,40);background-image: url(assets/img/feat-april-6-4.jpg);background-size: cover;">
        <form method="post" style="height: 701px;">
            <h2 class="sr-only">Login Form</h2>
            <div class="illustration"><i class="icon ion-android-checkbox-outline-blank" style="color: #e37544;"></i></div>
            <div class="form-group">
                ...
                <input class="form-control" type="password" name="senha" placeholder="Senha" required=""></div>
            <div class="form-group"><button class="btn btn-primary btn-block" type="submit" style="background-color: #e37544;">Entrar</button></div>
            <a class="forgot" href="login.aspx">Já tenho cadastro</a></form>
    </div>
